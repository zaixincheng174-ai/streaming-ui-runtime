...
- "F2 worker total time is worse." Response: Correct; the positive result is lower urgent acknowledgement and visible latency, not total throughput improvement.
