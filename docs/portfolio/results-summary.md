...
| 22.9ms → 3.3ms controlled urgent projection timing | `docs/portfolio/evidence-map.md` | Controlled timing evidence, not click-to-visible or user-perceived latency proof. |
